...
<body>
    ...
    <header>
        <div class="logo">
            ...
            <img src="images1.jpg" alt="Little Lemon Logo">
        </div>
        <nav>https
            <ul>
                <li><a href="#">Home</a></li>
    ...
    <main>
        ...
        <section class="content-columns">
            <article class="column">
                <h3>Our New Menu</h3>
                <img src="images2.jpg" alt="New Menu">
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse et congue massa, eu fringilla mauris.</p>
            ...
            <article class="column">
                <h3>Opening Hours</h3>
                <img src="images4.jpg" alt="Opening Hours">
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse et congue massa, eu fringilla mauris.</p>
    ...
    <footer>
        <div class="footer-logo">
            <img src="images5.jpg" alt="Little Lemon Logo">
        </div>
...
/* Promotional Banner */
.promo-banner {
    background: url("images6.jpg") center/cover no-repeat;
    color: #fff;
    text-align: center;
    padding: 50px 20px;
    margin-bottom: 20px;
